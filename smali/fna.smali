...
# direct methods
.method public constructor <init>(Landroid/app/Activity;Lfnh;Landroid/content/SharedPreferences;Lvit;Leae;)V
    .locals 3
    ...
    iput-object v0, p0, Lfna;->a:Landroid/app/Activity;
    ...
    iput-object v0, p0, Lfna;->c:Landroid/content/SharedPreferences;
    ...
    iput-object v0, p0, Lfna;->g:Leae;

    .line 80
    invoke-interface {p5, p0}, Leae;->a(Ldka;)V
    ...
    invoke-direct {v0, p0}, Lfnb;-><init>(Lfna;)V

    iput-object v0, p0, Lfna;->i:Lviu;

    .line 105
    iget-object v0, p0, Lfna;->i:Lviu;

    invoke-interface {p4, v0}, Lvit;->a(Lviu;)V

    .line 106
    return-void
.end method

.method public static a(Landroid/content/SharedPreferences;Lvit;)Z
    .locals 3

    .prologue
    .line 232
    invoke-interface {p1}, Lvit;->f()Lvkb;
    ...
    .line 2070
    iget-object v0, v0, Lvkb;->d:Ljava/lang/String;
...
.method public final a(Ldjz;Ldjz;)V
    ...
    .prologue
    .line 324
    invoke-virtual {p0}, Lfna;->a()Z

    move-result v0

    if-nez v0, :cond_0

    iget-object v0, p0, Lfna;->j:Lcom/google/android/apps/youtube/app/ui/tutorial/ClingTutorialLayout;
    ...
    invoke-direct {v1, p0}, Lfne;-><init>(Lfna;)V
...
.method public final a()Z
    ...
    .line 124
    :goto_0
    iget-object v3, p0, Lfna;->f:Ljava/lang/ref/WeakReference;
    ...
    .line 128
    :cond_1
    iget-object v0, p0, Lfna;->f:Ljava/lang/ref/WeakReference;
    ...
    .line 131
    invoke-virtual {p0}, Lfna;->b()Landroid/graphics/Point;

    move-result-object v2

    invoke-virtual {p0, v0, v2}, Lfna;->a(Landroid/view/View;Landroid/graphics/Point;)Z
...
.method final b()Landroid/graphics/Point;
    ...
    .line 137
    iget-object v0, p0, Lfna;->a:Landroid/app/Activity;
...
.method public final c()V
    ...
    .line 144
    iget-object v0, p0, Lfna;->k:Landroid/view/ViewGroup;
    ...
    iput-object v0, p0, Lfna;->k:Landroid/view/ViewGroup;
    ...
    iget-object v2, p0, Lfna;->k:Landroid/view/ViewGroup;
    ...
    iput-object v0, p0, Lfna;->j:Lcom/google/android/apps/youtube/app/ui/tutorial/ClingTutorialLayout;
    ...
    .line 1202
    iget-object v4, p0, Lfna;->a:Landroid/app/Activity;
    ...
    invoke-direct {v1, p0}, Lfnc;-><init>(Lfna;)V
    ...
    invoke-direct {v1, p0}, Lfnd;-><init>(Lfna;)V
    ...
    iget-object v1, p0, Lfna;->j:Lcom/google/android/apps/youtube/app/ui/tutorial/ClingTutorialLayout;
...
.method public final f()V
    ...
    .prologue
    .line 316
    iget-object v0, p0, Lfna;->b:Lfnh;

    invoke-virtual {v0, p0}, Lfnh;->b(Lfnl;)V

    .line 317
    iget-object v0, p0, Lfna;->d:Lvit;

    iget-object v1, p0, Lfna;->i:Lviu;
    ...
    iput-boolean v0, p0, Lfna;->e:Z

    .line 319
    const/4 v0, 0x0

    iput-object v0, p0, Lfna;->f:Ljava/lang/ref/WeakReference;
