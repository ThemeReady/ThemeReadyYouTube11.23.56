...
.field private final f:Luau;


# direct methods
.method public constructor <init>(Landroid/content/Context;Lszm;Llmb;Luau;)V
    .locals 1
    ...
    iput-object v0, p0, Ldzq;->a:Landroid/content/Context;
...
.method public final a()V
    ...
    .line 48
    iget-object v0, p0, Ldzq;->d:Landroid/app/AlertDialog;

    if-nez v0, :cond_6

    .line 1091
    iget-object v0, p0, Ldzq;->a:Landroid/content/Context;
    ...
    .line 1099
    iget-object v1, p0, Ldzq;->f:Luau;

    iget-object v3, v1, Luau;->a:[Luap;
    ...
    .line 1103
    iget-object v5, v5, Luap;->c:Luau;

    invoke-virtual {v5}, Luau;->ft_()Landroid/text/Spanned;
    ...
    .line 1113
    :goto_1
    iget-object v5, p0, Ldzq;->a:Landroid/content/Context;
    ...
    .line 1106
    iget-object v5, v5, Luap;->a:Luas;

    .line 2043
    iget-object v7, v5, Luas;->c:Landroid/text/Spanned;

    if-nez v7, :cond_2

    .line 2044
    iget-object v7, v5, Luas;->a:Ltcq;
    ...
    iput-object v7, v5, Luas;->c:Landroid/text/Spanned;

    .line 2047
    :cond_2
    iget-object v5, v5, Luas;->c:Landroid/text/Spanned;
    ...
    .line 1109
    iget-object v5, v5, Luap;->b:Luaq;

    .line 3040
    iget-object v7, v5, Luaq;->c:Landroid/text/Spanned;

    if-nez v7, :cond_4

    .line 3041
    iget-object v7, v5, Luaq;->a:Ltcq;
    ...
    iput-object v7, v5, Luaq;->c:Landroid/text/Spanned;

    .line 3044
    :cond_4
    iget-object v5, v5, Luaq;->c:Landroid/text/Spanned;
    ...
    iget-object v3, p0, Ldzq;->a:Landroid/content/Context;

    invoke-direct {v1, v3}, Landroid/app/AlertDialog$Builder;-><init>(Landroid/content/Context;)V

    iget-object v3, p0, Ldzq;->f:Luau;

    .line 1119
    invoke-virtual {v3}, Luau;->ft_()Landroid/text/Spanned;
    ...
    iget-object v3, p0, Ldzq;->e:Landroid/view/View;
    ...
    invoke-direct {v3, v1}, Ldzs;-><init>(Landroid/app/AlertDialog;)V
    ...
    .line 49
    iput-object v1, p0, Ldzq;->d:Landroid/app/AlertDialog;
    ...
    .line 87
    iget-object v1, p0, Ldzq;->d:Landroid/app/AlertDialog;
