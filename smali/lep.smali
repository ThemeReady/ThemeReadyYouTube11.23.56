...
# direct methods
.method public constructor <init>(Llfk;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)V
    .locals 1
    ...
    invoke-direct {v0, p1}, Llei;-><init>(Llfk;)V

    iput-object v0, p0, Llep;->a:Llei;
    ...
    iput-object v0, p0, Llep;->b:Landroid/net/Uri;
    ...
    .line 48
    iput-object p4, p0, Llep;->d:Ljava/lang/String;

    .line 49
    return-void
.end method

.method private static a(Lorg/apache/http/HttpResponse;)Lwdi;
    .locals 3
...
.method private static b(Lorg/apache/http/HttpResponse;)Lwdh;
    .locals 3
...
# virtual methods
.method public final a(Lloy;)Landroid/net/Uri;
    .locals 8
    ...
    .line 1135
    iget-object v1, p0, Llep;->b:Landroid/net/Uri;
    ...
    iget-object v3, p0, Llep;->c:Ljava/lang/String;
    ...
    invoke-virtual {v2, v1}, Llfu;->a(Landroid/net/Uri;)Lorg/apache/http/client/methods/HttpUriRequest;
    ...
    .line 1142
    iget-object v1, p0, Llep;->d:Ljava/lang/String;

    invoke-static {v2, v1}, Llep;->a(Lorg/apache/http/client/methods/HttpUriRequest;Ljava/lang/String;)V

    .line 61
    :goto_0
    invoke-virtual {p1}, Lloy;->b()J
    ...
    .line 63
    :try_start_0
    iget-object v1, p0, Llep;->a:Llei;

    invoke-virtual {v1, v2}, Llei;->a(Lorg/apache/http/client/methods/HttpUriRequest;)Lorg/apache/http/HttpResponse;

    move-result-object v1

    .line 64
    invoke-static {v1}, Llep;->a(Lorg/apache/http/HttpResponse;)Lwdi;

    move-result-object v1

    .line 65
    iget-object v1, v1, Lwdi;->a:[Ljava/lang/String;
    ...
    .line 2078
    :cond_1
    iget-object v1, p1, Lloy;->a:Llpa;

    .line 2135
    iget-wide v2, v1, Llpa;->c:J
...
.method public final a(Llej;Lloy;)Llev;
    .locals 8
    ...
    .line 2147
    iget-object v0, p0, Llep;->b:Landroid/net/Uri;
    ...
    .line 3021
    iget-object v2, p1, Llej;->a:Ljava/lang/String;
    ...
    invoke-virtual {v2, v0}, Llfu;->a(Landroid/net/Uri;)Lorg/apache/http/client/methods/HttpUriRequest;
    ...
    invoke-static {v2, v0}, Llep;->a(Lorg/apache/http/client/methods/HttpUriRequest;Ljava/lang/String;)V

    .line 106
    :goto_1
    invoke-virtual {p2}, Lloy;->b()J
    ...
    .line 108
    :try_start_0
    iget-object v0, p0, Llep;->a:Llei;

    invoke-virtual {v0, v2}, Llei;->a(Lorg/apache/http/client/methods/HttpUriRequest;)Lorg/apache/http/HttpResponse;
    :try_end_0
    .catch Lorg/apache/http/client/HttpResponseException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 129
    :cond_4
    invoke-static {v0}, Llep;->b(Lorg/apache/http/HttpResponse;)Lwdh;
    ...
    iget-object v2, v1, Lwdh;->a:[Lwdf;

    iget-wide v4, v1, Lwdh;->b:J

    invoke-direct {v0, p1, v2, v4, v5}, Llev;-><init>(Llej;[Lwdf;J)V
