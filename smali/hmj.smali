...
# direct methods
.method constructor <init>(Lhcm;Lcom/google/android/gms/wallet/firstparty/GetBuyFlowInitializationTokenRequest;)V
    .locals 0

    iput-object p2, p0, Lhmj;->a:Lcom/google/android/gms/wallet/firstparty/GetBuyFlowInitializationTokenRequest;

    invoke-direct {p0, p1}, Liij;-><init>(Lhcm;)V
...
# virtual methods
.method protected final synthetic a(Lcom/google/android/gms/common/api/Status;)Lhcv;
    .locals 2
    ...
    invoke-direct {v1, p1, v0}, Liiq;-><init>(Lcom/google/android/gms/common/api/Status;Lcom/google/android/gms/wallet/firstparty/GetBuyFlowInitializationTokenResponse;)V
...
.method protected final synthetic a(Lhcj;)V
    ...
    .line 1000
    iget-object v1, p0, Lhmj;->a:Lcom/google/android/gms/wallet/firstparty/GetBuyFlowInitializationTokenRequest;

    .line 2000
    new-instance v2, Lhmh;

    invoke-direct {v2, p0}, Lhmh;-><init>(Lhdc;)V

    .line 3000
    iget v0, p1, Lhmf;->b:I

    iget-object v3, p1, Lhmf;->a:Landroid/content/Context;

    invoke-virtual {v3}, Landroid/content/Context;->getPackageName()Ljava/lang/String;

    move-result-object v3

    iget-object v4, p1, Lhmf;->c:Ljava/lang/String;

    iget v5, p1, Lhmf;->d:I

    iget-boolean v6, p1, Lhmf;->e:Z
    ...
    .line 2000
    :try_start_0
    invoke-virtual {p1}, Lhmf;->l()Landroid/os/IInterface;

    move-result-object v0

    check-cast v0, Lhlv;

    invoke-interface {v0, v1, v7, v2}, Lhlv;->a(Lcom/google/android/gms/wallet/firstparty/GetBuyFlowInitializationTokenRequest;Landroid/os/Bundle;Lhmb;)V
    :try_end_0
    ...
    invoke-virtual {v2, v1, v0, v3}, Lhmh;->a(Lcom/google/android/gms/common/api/Status;Lcom/google/android/gms/wallet/firstparty/GetBuyFlowInitializationTokenResponse;Landroid/os/Bundle;)V
