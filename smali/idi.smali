...
# direct methods
.method constructor <init>(Lidf;Landroid/content/Context;Ljava/lang/String;)V
    .locals 2
...
.method private final a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)V
    ...
    .prologue
    .line 0
    invoke-direct {p0, p1, p2}, Lidi;->a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Z
    ...
    :cond_0
    :try_start_0
    invoke-static {p1, p2}, Lidi;->b(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Ljava/util/Set;
    ...
    invoke-virtual {v1, v2, p2}, Lidz;->a(Ljava/lang/String;Ljava/lang/Object;)V
...
.method private final a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Z
    ...
    :goto_1
    :try_start_2
    iget-object v2, p0, Lidi;->a:Lidf;

    invoke-virtual {v2}, Lidf;->s()Lidx;
    ...
    invoke-virtual {v2, v3, p2, v0}, Lidz;->a(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V
    :try_end_2
...
.method public final getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-static {v1}, Lidf;->a(Lidf;)Licx;

    move-result-object v1

    invoke-static {}, Lide;->G()J

    .line 1000
    iget-wide v2, v1, Licx;->b:J
    ...
    .line 1000
    :cond_1
    iget-object v2, v1, Licx;->a:Lhhl;

    invoke-interface {v2}, Lhhl;->b()J

    move-result-wide v2

    iget-wide v4, v1, Licx;->b:J
    ...
    invoke-static {v0}, Lidf;->a(Lidf;)Licx;
    ...
    invoke-static {v0}, Lidf;->b(Lidf;)Ljava/lang/String;

    move-result-object v0

    iget-object v1, p0, Lidi;->a:Lidf;

    invoke-virtual {v1}, Lidf;->m()Landroid/content/Context;
...
.method public final onOpen(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-direct/range {v0 .. v5}, Lidi;->a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)V
    ...
    .line 8000
    sget-object v11, Lidf;->a:Ljava/util/Map;
    ...
    .line 0
    invoke-direct/range {v6 .. v11}, Lidi;->a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)V
