...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lgxs;->b:Landroid/content/ComponentName;
...
.method static a(Landroid/content/Context;Landroid/content/ComponentName;Lgxx;)Ljava/lang/Object;
    .locals 5
    ...
    invoke-static {p0}, Lhge;->a(Landroid/content/Context;)Lhge;

    move-result-object v2

    const-string v0, "GoogleAuthUtil"

    invoke-virtual {v2, p1, v1, v0}, Lhge;->a(Landroid/content/ComponentName;Landroid/content/ServiceConnection;Ljava/lang/String;)Z
    ...
    :try_start_0
    invoke-virtual {v1}, Lhhy;->a()Landroid/os/IBinder;

    move-result-object v0

    invoke-interface {p2, v0}, Lgxx;->a(Landroid/os/IBinder;)Ljava/lang/Object;
    :try_end_0
    ...
    invoke-virtual {v2, p1, v1, v3}, Lhge;->b(Landroid/content/ComponentName;Landroid/content/ServiceConnection;Ljava/lang/String;)V
...
.method static a(Landroid/content/Context;)V
    ...
    invoke-static {v0}, Lhcb;->d(Landroid/content/Context;)V
    :try_end_0
    ...
    invoke-direct {v1, v2, v3, v0}, Lgxy;-><init>(ILjava/lang/String;Landroid/content/Intent;)V
    ...
    invoke-virtual {v0}, Lhby;->getMessage()Ljava/lang/String;

    move-result-object v0

    invoke-direct {v1, v0}, Lgxq;-><init>(Ljava/lang/String;)V
...
.method static c(Landroid/content/Context;Ljava/lang/String;)[Landroid/accounts/Account;
    ...
    .line 0
    invoke-static {p0}, Lhbx;->c(Landroid/content/Context;)V
