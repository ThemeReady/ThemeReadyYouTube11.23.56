...
.method private native nativeCreateGpuBuffer(JIIILioi;)J
.end method


# virtual methods
.method public final a(Lioh;)Lcom/google/android/libraries/drishti/framework/DrishtiPacket;
    .locals 8
    ...
    .line 196
    invoke-interface {p1}, Lioh;->a()I

    move-result v4

    .line 197
    invoke-interface {p1}, Lioh;->b()I

    move-result v5

    invoke-interface {p1}, Lioh;->c()I
    ...
    .line 195
    invoke-direct/range {v1 .. v7}, Lcom/google/android/libraries/drishti/framework/DrishtiPacketCreator;->nativeCreateGpuBuffer(JIIILioi;)J
