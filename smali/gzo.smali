...
.method public constructor <init>(Lgzl;Lhcm;Lhcm;Lorg/json/JSONObject;)V
    ...
    iput-object p1, p0, Lgzo;->i:Lgzl;

    iput-object p3, p0, Lgzo;->g:Lhcm;

    const/4 v0, 0x0

    iput-object v0, p0, Lgzo;->h:Lorg/json/JSONObject;
...
.method protected final synthetic a(Lhcj;)V
    ...
    .line 1000
    iget-object v2, p0, Lgzo;->a:Lhbh;

    const/4 v3, 0x1

    iget-object v4, p0, Lgzo;->h:Lorg/json/JSONObject;

    invoke-virtual {v0, v2, v3, v4}, Lhbf;->a(Lhbh;ILorg/json/JSONObject;)J
    :try_end_1
    ...
    invoke-virtual {p0, v0}, Lgzo;->b(Lcom/google/android/gms/common/api/Status;)Lgzx;

    move-result-object v0

    invoke-virtual {p0, v0}, Lgzo;->a(Lhcv;)V
    :try_end_3
