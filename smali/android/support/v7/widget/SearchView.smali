...
.field public static final HIDDEN_METHOD_INVOKER:Lapv;
...
.field private mOnCloseListener:Lapw;
...
.field private mOnQueryChangeListener:Lapx;

.field private mOnQueryTextFocusChangeListener:Landroid/view/View$OnFocusChangeListener;

.field private mOnSearchClickListener:Landroid/view/View$OnClickListener;

.field private mOnSuggestionListener:Lapy;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/SearchView;->HIDDEN_METHOD_INVOKER:Lapv;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v0, p0}, Laps;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-virtual {v1, v2, v3}, Laql;->e(II)I
    ...
    invoke-virtual {v1, v2}, Laql;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v1, v0}, Laql;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v1, v0, v2}, Laql;->e(II)I
    ...
    invoke-direct {v2, p0}, Lapp;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-virtual {v1, v0, v5}, Laql;->a(IZ)Z
    ...
    invoke-virtual {v1, v0, v4}, Laql;->c(II)I
    ...
    invoke-virtual {v1, v0}, Laql;->c(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v1, v0, v4}, Laql;->a(II)I
    ...
    .line 3181
    iget-object v0, v1, Laql;->a:Landroid/content/res/TypedArray;
...
.method private addOnLayoutChangeListenerToDropDownAnchorSDK11()V
    ...
    invoke-direct {v1, p0}, Lapq;-><init>(Landroid/support/v7/widget/SearchView;)V
...
.method private createIntentFromSuggestion(Landroid/database/Cursor;ILjava/lang/String;)Landroid/content/Intent;
    ...
    invoke-static {p1, v0}, Laqd;->a(Landroid/database/Cursor;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, v2}, Laqd;->a(Landroid/database/Cursor;Ljava/lang/String;)Ljava/lang/String;
...
.method private forceSuggestionQuery()V
    ...
    .prologue
    .line 1662
    sget-object v0, Landroid/support/v7/widget/SearchView;->HIDDEN_METHOD_INVOKER:Lapv;

    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->mSearchSrcTextView:Landroid/support/v7/widget/SearchView$SearchAutoComplete;

    .line 6843
    iget-object v2, v0, Lapv;->a:Ljava/lang/reflect/Method;

    if-eqz v2, :cond_0

    .line 6845
    :try_start_0
    iget-object v0, v0, Lapv;->a:Ljava/lang/reflect/Method;
    ...
    .line 6852
    iget-object v2, v0, Lapv;->b:Ljava/lang/reflect/Method;

    if-eqz v2, :cond_1

    .line 6854
    :try_start_1
    iget-object v0, v0, Lapv;->b:Ljava/lang/reflect/Method;
...
.method private onCloseClicked()V
    ...
    .line 1178
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mOnCloseListener:Lapw;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mOnCloseListener:Lapw;

    invoke-interface {v0}, Lapw;->a()Z
...
.method private onItemClicked(IILjava/lang/String;)Z
    ...
    .line 1351
    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->mOnSuggestionListener:Lapy;

    if-eqz v1, :cond_0

    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->mOnSuggestionListener:Lapy;

    invoke-interface {v1}, Lapy;->b()Z
...
.method private onItemSelected(I)Z
    ...
    .prologue
    .line 1362
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mOnSuggestionListener:Lapy;
...
.method private onSubmitQuery()V
    ...
    .line 1158
    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->mOnQueryChangeListener:Lapx;
...
.method private onSuggestionsKey(Landroid/view/View;ILandroid/view/KeyEvent;)Z
    ...
    invoke-virtual {v0, v1}, Lapv;->a(Landroid/widget/AutoCompleteTextView;)V
...
.method private onTextChanged(Ljava/lang/CharSequence;)V
    ...
    .line 1149
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mOnQueryChangeListener:Lapx;
...
.method private updateSearchAutoComplete()V
    ...
    invoke-direct {v0, v2, p0, v3, v4}, Laqd;-><init>(Landroid/content/Context;Landroid/support/v7/widget/SearchView;Landroid/app/SearchableInfo;Ljava/util/WeakHashMap;)V
...
.method public clearFocus()V
    ...
    .line 513
    invoke-super {p0}, Lamt;->clearFocus()V
...
.method protected onDetachedFromWindow()V
    ...
    .line 920
    invoke-super {p0}, Lamt;->onDetachedFromWindow()V
...
.method protected onMeasure(II)V
    ...
    .line 785
    invoke-super {p0, p1, p2}, Lamt;->onMeasure(II)V
    ...
    invoke-super {p0, v0, p2}, Lamt;->onMeasure(II)V
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 1317
    invoke-super {p0, p1}, Lamt;->onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 1321
    invoke-virtual {p1}, Lapz;->getSuperState()Landroid/os/Parcelable;

    move-result-object v0

    invoke-super {p0, v0}, Lamt;->onRestoreInstanceState(Landroid/os/Parcelable;)V

    .line 1322
    iget-boolean v0, p1, Lapz;->a:Z
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    .prologue
    .line 1308
    invoke-super {p0}, Lamt;->onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-direct {v1, v0}, Lapz;-><init>(Landroid/os/Parcelable;)V
...
.method public onWindowFocusChanged(Z)V
    ...
    .prologue
    .line 1238
    invoke-super {p0, p1}, Lamt;->onWindowFocusChanged(Z)V
...
.method public requestFocus(ILandroid/graphics/Rect;)Z
    ...
    .line 504
    :cond_3
    invoke-super {p0, p1, p2}, Lamt;->requestFocus(ILandroid/graphics/Rect;)Z
...
.method public setOnCloseListener(Lapw;)V
    .locals 0

    .prologue
    .line 534
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->mOnCloseListener:Lapw;
...
.method public setOnQueryTextListener(Lapx;)V
    .locals 0

    .prologue
    .line 525
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->mOnQueryChangeListener:Lapx;
...
.method public setOnSuggestionListener(Lapy;)V
    .locals 0

    .prologue
    .line 552
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->mOnSuggestionListener:Lapy;
