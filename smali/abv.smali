...
# direct methods
.method static a(Landroid/app/Notification;Lhj;)V
    .locals 14
    ...
    .line 60
    iget-object v0, p1, Lhj;->a:Landroid/content/Context;

    iget-object v1, p1, Lhj;->b:Ljava/lang/CharSequence;

    iget-object v2, p1, Lhj;->c:Ljava/lang/CharSequence;

    iget-object v3, p1, Lhj;->f:Ljava/lang/CharSequence;

    iget-object v5, p1, Lhj;->e:Landroid/graphics/Bitmap;

    iget-object v6, p1, Lhj;->j:Ljava/lang/CharSequence;

    iget-object v7, p1, Lhj;->t:Landroid/app/Notification;

    iget-wide v8, v7, Landroid/app/Notification;->when:J

    iget-object v12, p1, Lhj;->p:Ljava/util/ArrayList;
    ...
    .line 2119
    invoke-static/range {v0 .. v11}, Lacb;->a(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJIZ)Landroid/widget/RemoteViews;
    ...
    invoke-static {v0, v1}, Lacb;->a(Landroid/content/Context;Lib;)Landroid/widget/RemoteViews;
...
.method static a(Lhc;Lhj;)V
    ...
    iget-object v8, p1, Lhj;->t:Landroid/app/Notification;

    iget-wide v8, v8, Landroid/app/Notification;->when:J

    iget-object v12, p1, Lhj;->p:Ljava/util/ArrayList;

    iget-object v13, v7, Laca;->a:[I
    ...
    .line 2054
    invoke-interface {p0}, Lhc;->a()Landroid/app/Notification$Builder;
...
.method static b(Lhc;Lhv;)V
    ...
    .line 37
    iget-object v1, p1, Laca;->a:[I

    iget-object v0, p1, Laca;->d:Lmp;
