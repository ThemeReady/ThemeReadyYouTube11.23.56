...
.field private static C:Lhoe;

.field private static D:Z

.field private static E:Lhbo;

.field private static F:Lbou;
...
.method static constructor <clinit>()V
    ...
    sput-wide v0, Lhnw;->B:J

    sput-boolean v2, Lhnw;->D:Z

    const/4 v0, 0x0

    sput-object v0, Lhnw;->E:Lhbo;

    new-instance v0, Ljava/util/Random;

    invoke-direct {v0}, Ljava/util/Random;-><init>()V

    sput-object v0, Lhnw;->G:Ljava/util/Random;

    .line 34000
    sget-object v0, Lhbx;->c:Lhbx;

    .line 0
    sput-object v0, Lhnw;->H:Lhbx;

    sput-boolean v2, Lhnw;->J:Z

    sput-boolean v2, Lhnw;->K:Z

    sput-boolean v2, Lhnw;->L:Z

    sput-boolean v2, Lhnw;->M:Z
...
.method protected constructor <init>(Landroid/content/Context;Lhod;)V
    .locals 2

    invoke-direct {p0, p1, p2}, Lhnu;-><init>(Landroid/content/Context;Lhod;)V

    new-instance v0, Lbou;

    invoke-direct {v0}, Lbou;-><init>()V

    sput-object v0, Lhnw;->F:Lbou;

    invoke-virtual {p1}, Landroid/content/Context;->getPackageName()Ljava/lang/String;

    move-result-object v1

    iput-object v1, v0, Lbou;->a:Ljava/lang/String;

    return-void
.end method

.method private static a(Landroid/content/Context;Lhod;)Ljava/lang/String;
    .locals 4

    sget-object v0, Lhnw;->z:Ljava/lang/String;
    ...
    :cond_0
    sget-object v0, Lhnw;->o:Ljava/lang/reflect/Method;
    ...
    invoke-direct {v1, v0}, Lhnx;-><init>(Ljava/lang/Throwable;)V
    ...
    invoke-interface {p1, v0}, Lhod;->a([B)Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lhnw;->z:Ljava/lang/String;
    :try_end_1
...
.method private static a([BLjava/lang/String;)Ljava/lang/String;
    ...
    sget-object v1, Lhnw;->C:Lhoe;

    invoke-virtual {v1, p0, p1}, Lhoe;->a([BLjava/lang/String;)[B
...
.method private static a(Landroid/view/MotionEvent;Landroid/util/DisplayMetrics;)Ljava/util/ArrayList;
    ...
    sget-object v0, Lhnw;->p:Ljava/lang/reflect/Method;
...
.method protected static a(II)V
    ...
    .prologue
    .line 0
    sget-boolean v0, Lhnw;->M:Z

    if-eqz v0, :cond_1

    sget-boolean v0, Lhnw;->J:Z

    if-eqz v0, :cond_1

    sget-object v0, Lhnw;->E:Lhbo;

    if-eqz v0, :cond_1

    sget-object v0, Lhnw;->E:Lhbo;

    sget-object v1, Lhnw;->F:Lbou;

    invoke-static {v1}, Lhnj;->a(Lhnj;)[B

    move-result-object v1

    invoke-virtual {v0, v1}, Lhbo;->a([B)Lhbq;

    move-result-object v0

    .line 32000
    iget-object v1, v0, Lhbq;->a:Lhnr;

    iput p1, v1, Lhnr;->d:I

    .line 0
    invoke-virtual {v0, p0}, Lhbq;->a(I)Lhbq;

    sget-object v1, Lhnw;->i:Lhcm;
    ...
    invoke-interface {v2, v1, v0}, Lhbt;->a(Lhcm;Lcom/google/android/gms/clearcut/LogEventParcelable;)Lhcs;
...
.method protected static declared-synchronized a(Ljava/lang/String;Landroid/content/Context;Lhod;)V
    .locals 21
    ...
    invoke-direct {v2, v0}, Lhoe;-><init>(Lhod;)V

    sput-object v2, Lhnw;->C:Lhoe;

    sput-object p0, Lhnw;->y:Ljava/lang/String;

    invoke-static/range {p1 .. p1}, Lgru;->a(Landroid/content/Context;)V
    :try_end_1
    .catch Lhnx; {:try_start_1 .. :try_end_1} :catch_1
    .catch Ljava/lang/UnsupportedOperationException; {:try_start_1 .. :try_end_1} :catch_2
    .catchall {:try_start_1 .. :try_end_1} :catchall_1

    .line 1000
    :try_start_2
    sget-object v2, Lhnw;->C:Lhoe;

    .line 2000
    const-string v3, "QpmJ8ul06jlIzFufLfsNAWUj2KYEV5t//bwTAlu38Ok="

    .line 1000
    invoke-virtual {v2, v3}, Lhoe;->a(Ljava/lang/String;)[B
    ...
    .line 1000
    invoke-virtual {v2, v5, v3}, Lhoe;->a([BLjava/lang/String;)[B
    ...
    .catch Lhof; {:try_start_2 .. :try_end_2} :catch_5
    .catch Ljava/lang/NoSuchMethodException; {:try_start_2 .. :try_end_2} :catch_6
    .catch Ljava/lang/NullPointerException; {:try_start_2 .. :try_end_2} :catch_7
    .catch Lhnx; {:try_start_2 .. :try_end_2} :catch_1
    ...
    invoke-direct {v3, v2}, Lhnx;-><init>(Ljava/lang/Throwable;)V

    throw v3
    :try_end_3
    .catch Lhnx; {:try_start_3 .. :try_end_3} :catch_1
    ...
    .line 1000
    invoke-static {v5, v6}, Lhnw;->a([BLjava/lang/String;)Ljava/lang/String;
    ...
    .line 1000
    invoke-static {v5, v8}, Lhnw;->a([BLjava/lang/String;)Ljava/lang/String;
    ...
    .line 1000
    invoke-static {v5, v9}, Lhnw;->a([BLjava/lang/String;)Ljava/lang/String;
    ...
    .line 1000
    invoke-static {v5, v10}, Lhnw;->a([BLjava/lang/String;)Ljava/lang/String;
    ...
    .line 1000
    invoke-static {v5, v11}, Lhnw;->a([BLjava/lang/String;)Ljava/lang/String;
    ...
    .line 1000
    invoke-static {v5, v12}, Lhnw;->a([BLjava/lang/String;)Ljava/lang/String;
    ...
    .line 1000
    invoke-static {v5, v13}, Lhnw;->a([BLjava/lang/String;)Ljava/lang/String;
    ...
    .line 1000
    invoke-static {v5, v14}, Lhnw;->a([BLjava/lang/String;)Ljava/lang/String;
    ...
    .line 1000
    invoke-static {v5, v15}, Lhnw;->a([BLjava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v5, v0}, Lhnw;->a([BLjava/lang/String;)Ljava/lang/String;
    ...
    sput-object v6, Lhnw;->j:Ljava/lang/reflect/Method;
    ...
    sput-object v6, Lhnw;->m:Ljava/lang/reflect/Method;
    ...
    sput-object v6, Lhnw;->n:Ljava/lang/reflect/Method;
    ...
    sput-object v6, Lhnw;->o:Ljava/lang/reflect/Method;
    ...
    sput-object v6, Lhnw;->p:Ljava/lang/reflect/Method;
    ...
    sput-object v6, Lhnw;->q:Ljava/lang/reflect/Method;
    ...
    sput-object v6, Lhnw;->r:Ljava/lang/reflect/Method;
    ...
    sput-object v6, Lhnw;->s:Ljava/lang/reflect/Method;
    ...
    sput-object v6, Lhnw;->t:Ljava/lang/reflect/Method;
    ...
    sput-object v6, Lhnw;->u:Ljava/lang/reflect/Method;
    ...
    sput-object v6, Lhnw;->v:Ljava/lang/reflect/Method;
    ...
    sput-object v6, Lhnw;->w:Ljava/lang/reflect/Method;
    ...
    sput-object v2, Lhnw;->x:Ljava/lang/reflect/Method;
    :try_end_5
    ...
    .catch Lhof; {:try_start_6 .. :try_end_6} :catch_5
    ...
    sput-wide v2, Lhnw;->B:J

    new-instance v2, Ljava/util/Random;

    invoke-direct {v2}, Ljava/util/Random;-><init>()V

    sput-object v2, Lhnw;->G:Ljava/util/Random;
    :try_end_7
    .catch Lhnx; {:try_start_7 .. :try_end_7} :catch_1
    ...
    invoke-direct {v2, v0}, Lhcn;-><init>(Landroid/content/Context;)V

    sget-object v3, Lhbo;->b:Lhcf;

    invoke-virtual {v2, v3}, Lhcn;->a(Lhcf;)Lhcn;

    move-result-object v2

    invoke-virtual {v2}, Lhcn;->b()Lhcm;

    move-result-object v2

    sput-object v2, Lhnw;->i:Lhcm;

    .line 30000
    sget-object v2, Lhbx;->c:Lhbx;

    .line 0
    sput-object v2, Lhnw;->H:Lhbx;

    move-object/from16 v0, p1

    invoke-virtual {v2, v0}, Lhbx;->a(Landroid/content/Context;)I
    ...
    :goto_1
    sput-boolean v2, Lhnw;->I:Z

    invoke-static/range {p1 .. p1}, Lgru;->a(Landroid/content/Context;)V

    sget-object v2, Lgru;->k:Lgrp;

    invoke-virtual {v2}, Lgrp;->a()Ljava/lang/Object;
    ...
    invoke-direct {v2, v0, v3, v5}, Lhbo;-><init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V

    sput-object v2, Lhnw;->E:Lhbo;
    :try_end_8
    .catch Ljava/lang/NoClassDefFoundError; {:try_start_8 .. :try_end_8} :catch_8
    .catch Lhnx; {:try_start_8 .. :try_end_8} :catch_1
    .catch Ljava/lang/UnsupportedOperationException; {:try_start_8 .. :try_end_8} :catch_2
    .catchall {:try_start_8 .. :try_end_8} :catchall_1

    :goto_2
    :try_start_9
    sget-object v2, Lhnw;->H:Lhbx;

    move-object/from16 v0, p1

    invoke-virtual {v2, v0}, Lhbx;->b(Landroid/content/Context;)I
    ...
    sput-boolean v2, Lhnw;->D:Z
    :try_end_9
    .catch Lhnx; {:try_start_9 .. :try_end_9} :catch_1
    ...
    .catch Lhof; {:try_start_a .. :try_end_a} :catch_5
    ...
    .catch Lhnx; {:try_start_a .. :try_end_a} :catch_1
    ...
    throw v3
    :try_end_b
    .catch Lhnx; {:try_start_b .. :try_end_b} :catch_1
    ...
    throw v3
    :try_end_c
    .catch Lhnx; {:try_start_c .. :try_end_c} :catch_1
...
.method private static b(Landroid/content/Context;Lhod;)Ljava/lang/String;
    .locals 4

    sget-object v0, Lhnw;->A:Ljava/lang/String;
    ...
    :cond_0
    sget-object v0, Lhnw;->r:Ljava/lang/reflect/Method;
    ...
    sput-object v0, Lhnw;->A:Ljava/lang/String;
    :try_end_1
    .catch Ljava/lang/IllegalAccessException; {:try_start_1 .. :try_end_1} :catch_0
    .catch Ljava/lang/reflect/InvocationTargetException; {:try_start_1 .. :try_end_1} :catch_1
...
.method private static c()V
    ...
    sget-boolean v0, Lhnw;->I:Z

    if-eqz v0, :cond_0

    sget-object v0, Lhnw;->i:Lhcm;

    invoke-virtual {v0}, Lhcm;->c()V

    const/4 v0, 0x1

    sput-boolean v0, Lhnw;->M:Z
...
.method private static d(Landroid/content/Context;)Ljava/lang/String;
    ...
    sget-object v0, Lhnw;->u:Ljava/lang/reflect/Method;
...
.method private static d()V
    ...
    .line 31000
    iget-object v0, v0, Lhbo;->c:Lhbt;

    const-wide/16 v2, 0x64

    invoke-interface {v0, v2, v3, v1}, Lhbt;->a(JLjava/util/concurrent/TimeUnit;)Z
...
.method private static e()Ljava/lang/String;
    ...
    sget-object v0, Lhnw;->y:Ljava/lang/String;
...
.method static e(Landroid/content/Context;)Ljava/lang/String;
    ...
    sget-object v0, Lhnw;->q:Ljava/lang/reflect/Method;
...
.method private static f()Ljava/lang/Long;
    ...
    sget-object v0, Lhnw;->j:Ljava/lang/reflect/Method;
...
.method private static f(Landroid/content/Context;)Ljava/lang/Long;
    ...
    sget-object v0, Lhnw;->v:Ljava/lang/reflect/Method;
...
.method private static g()Ljava/lang/String;
    ...
    sget-object v0, Lhnw;->n:Ljava/lang/reflect/Method;
...
.method private static g(Landroid/content/Context;)Ljava/util/ArrayList;
    ...
    sget-object v0, Lhnw;->s:Ljava/lang/reflect/Method;
...
.method private static h()Ljava/lang/Long;
    ...
    sget-object v0, Lhnw;->m:Ljava/lang/reflect/Method;
...
.method private static h(Landroid/content/Context;)[I
    ...
    sget-object v0, Lhnw;->t:Ljava/lang/reflect/Method;
...
.method private static i(Landroid/content/Context;)I
    ...
    sget-object v0, Lhnw;->w:Ljava/lang/reflect/Method;
...
.method private static j(Landroid/content/Context;)I
    ...
    sget-object v0, Lhnw;->x:Ljava/lang/reflect/Method;
...
# virtual methods
.method protected b(Landroid/content/Context;)Lbow;
    .locals 8
    ...
    :try_start_0
    invoke-static {}, Lhnw;->c()V

    sget-object v0, Lhnw;->G:Ljava/util/Random;
    ...
    invoke-static {v0, v2}, Lhnw;->a(II)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0

    :try_start_1
    invoke-static {}, Lhnw;->g()Ljava/lang/String;

    move-result-object v0

    iput-object v0, v1, Lbow;->a:Ljava/lang/String;
    ...
    invoke-static {v0, v2}, Lhnw;->a(II)V
    :try_end_1
    .catch Lhnx; {:try_start_1 .. :try_end_1} :catch_c
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_0

    :goto_0
    :try_start_2
    invoke-static {}, Lhnw;->e()Ljava/lang/String;

    move-result-object v0

    iput-object v0, v1, Lbow;->b:Ljava/lang/String;
    ...
    invoke-static {v0, v2}, Lhnw;->a(II)V
    :try_end_2
    .catch Lhnx; {:try_start_2 .. :try_end_2} :catch_b
    ...
    iput-object v0, v1, Lbow;->D:Ljava/lang/Long;

    sget-wide v4, Lhnw;->B:J
    ...
    iput-object v0, v1, Lbow;->j:Ljava/lang/Long;

    sget-wide v2, Lhnw;->B:J

    invoke-static {v2, v3}, Ljava/lang/Long;->valueOf(J)Ljava/lang/Long;

    move-result-object v0

    iput-object v0, v1, Lbow;->l:Ljava/lang/Long;
    ...
    invoke-static {v0, v2}, Lhnw;->a(II)V
    :try_end_3
    .catch Lhnx; {:try_start_3 .. :try_end_3} :catch_a
    .catch Ljava/io/IOException; {:try_start_3 .. :try_end_3} :catch_0

    :goto_2
    :try_start_4
    invoke-static {p1}, Lhnw;->g(Landroid/content/Context;)Ljava/util/ArrayList;
    ...
    iput-object v0, v1, Lbow;->o:Ljava/lang/Long;
    ...
    iput-object v0, v1, Lbow;->p:Ljava/lang/Long;
    ...
    invoke-static {v0, v2}, Lhnw;->a(II)V
    :try_end_4
    .catch Lhnx; {:try_start_4 .. :try_end_4} :catch_9
    .catch Ljava/io/IOException; {:try_start_4 .. :try_end_4} :catch_0

    :goto_3
    :try_start_5
    invoke-static {}, Lhnw;->h()Ljava/lang/Long;

    move-result-object v0

    iput-object v0, v1, Lbow;->q:Ljava/lang/Long;
    ...
    invoke-static {v0, v2}, Lhnw;->a(II)V
    :try_end_5
    .catch Lhnx; {:try_start_5 .. :try_end_5} :catch_8
    .catch Ljava/io/IOException; {:try_start_5 .. :try_end_5} :catch_0

    :goto_4
    :try_start_6
    sget-boolean v0, Lhnw;->K:Z

    if-eqz v0, :cond_1

    sget-boolean v0, Lhnw;->L:Z

    if-nez v0, :cond_2

    :cond_1
    iget-object v0, p0, Lhnw;->h:Lhod;

    invoke-static {p1, v0}, Lhnw;->a(Landroid/content/Context;Lhod;)Ljava/lang/String;

    move-result-object v0

    iput-object v0, v1, Lbow;->m:Ljava/lang/String;
    ...
    invoke-static {v0, v2}, Lhnw;->a(II)V
    :try_end_6
    .catch Lhnx; {:try_start_6 .. :try_end_6} :catch_7
    ...
    invoke-static {p1, v0}, Lhnw;->b(Landroid/content/Context;Lhod;)Ljava/lang/String;

    move-result-object v0

    iput-object v0, v1, Lbow;->n:Ljava/lang/String;
    ...
    invoke-static {v0, v2}, Lhnw;->a(II)V
    :try_end_7
    .catch Lhnx; {:try_start_7 .. :try_end_7} :catch_6
    .catch Ljava/io/IOException; {:try_start_7 .. :try_end_7} :catch_0

    :goto_6
    :try_start_8
    invoke-static {p1}, Lhnw;->h(Landroid/content/Context;)[I
    ...
    iput-object v2, v1, Lbow;->d:Ljava/lang/Long;
    ...
    iput-object v0, v1, Lbow;->e:Ljava/lang/Long;
    ...
    invoke-static {v0, v2}, Lhnw;->a(II)V
    :try_end_8
    .catch Lhnx; {:try_start_8 .. :try_end_8} :catch_5
    .catch Ljava/io/IOException; {:try_start_8 .. :try_end_8} :catch_0

    :goto_7
    :try_start_9
    invoke-static {p1}, Lhnw;->i(Landroid/content/Context;)I
    ...
    iput-object v0, v1, Lbow;->f:Ljava/lang/Long;
    ...
    invoke-static {v0, v2}, Lhnw;->a(II)V
    :try_end_9
    .catch Lhnx; {:try_start_9 .. :try_end_9} :catch_4
    .catch Ljava/io/IOException; {:try_start_9 .. :try_end_9} :catch_0

    :goto_8
    :try_start_a
    invoke-static {p1}, Lhnw;->j(Landroid/content/Context;)I
    ...
    iput-object v0, v1, Lbow;->c:Ljava/lang/Long;
    ...
    invoke-static {v0, v2}, Lhnw;->a(II)V
    :try_end_a
    .catch Lhnx; {:try_start_a .. :try_end_a} :catch_3
    .catch Ljava/io/IOException; {:try_start_a .. :try_end_a} :catch_0

    :goto_9
    :try_start_b
    invoke-static {p1}, Lhnw;->d(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v0

    iput-object v0, v1, Lbow;->r:Ljava/lang/String;
    ...
    invoke-static {v0, v2}, Lhnw;->a(II)V
    :try_end_b
    .catch Lhnx; {:try_start_b .. :try_end_b} :catch_2
    .catch Ljava/io/IOException; {:try_start_b .. :try_end_b} :catch_0

    :goto_a
    :try_start_c
    invoke-static {p1}, Lhnw;->f(Landroid/content/Context;)Ljava/lang/Long;

    move-result-object v0

    iput-object v0, v1, Lbow;->s:Ljava/lang/Long;
...
.method protected c(Landroid/content/Context;)Lbow;
    .locals 8
    ...
    iput-object v0, v2, Lbow;->b:Ljava/lang/String;
    :try_end_1
    .catch Lhnx; {:try_start_1 .. :try_end_1} :catch_7
    ...
    iput-object v0, v2, Lbow;->a:Ljava/lang/String;
    :try_end_2
    .catch Lhnx; {:try_start_2 .. :try_end_2} :catch_6
    ...
    iput-object v0, v2, Lbow;->D:Ljava/lang/Long;
    :try_end_3
    .catch Lhnx; {:try_start_3 .. :try_end_3} :catch_5
    ...
    invoke-static {v0, v3}, Lhnw;->a(II)V
    :try_end_4
    .catch Ljava/io/IOException; {:try_start_4 .. :try_end_4} :catch_1

    :try_start_5
    iget-object v0, p0, Lhnw;->a:Landroid/view/MotionEvent;

    iget-object v3, p0, Lhnw;->g:Landroid/util/DisplayMetrics;

    invoke-static {v0, v3}, Lhnw;->a(Landroid/view/MotionEvent;Landroid/util/DisplayMetrics;)Ljava/util/ArrayList;
    ...
    iput-object v0, v2, Lbow;->g:Ljava/lang/Long;
    ...
    iput-object v0, v2, Lbow;->h:Ljava/lang/Long;
    ...
    iput-object v0, v2, Lbow;->i:Ljava/lang/Long;
    ...
    iput-object v0, v2, Lbow;->t:Ljava/lang/Long;
    ...
    iput-object v0, v2, Lbow;->u:Ljava/lang/Long;
    ...
    invoke-static {v0, v3}, Lhnw;->a(II)V
    :try_end_5
    .catch Lhnx; {:try_start_5 .. :try_end_5} :catch_4
    .catch Ljava/io/IOException; {:try_start_5 .. :try_end_5} :catch_1

    :goto_3
    :try_start_6
    iget-wide v4, p0, Lhnw;->c:J
    ...
    iput-object v0, v2, Lbow;->x:Ljava/lang/Long;

    :cond_1
    iget-wide v4, p0, Lhnw;->d:J
    ...
    iput-object v0, v2, Lbow;->w:Ljava/lang/Long;

    :cond_2
    iget-wide v4, p0, Lhnw;->e:J
    ...
    iput-object v0, v2, Lbow;->v:Ljava/lang/Long;

    :cond_3
    iget-wide v4, p0, Lhnw;->f:J
    ...
    iput-object v0, v2, Lbow;->y:Ljava/lang/Long;
    :try_end_6
    .catch Ljava/io/IOException; {:try_start_6 .. :try_end_6} :catch_1

    :cond_4
    :try_start_7
    iget-object v0, p0, Lhnw;->b:Ljava/util/LinkedList;
    ...
    new-array v0, v3, [Lbox;

    iput-object v0, v2, Lbow;->z:[Lbox;
    ...
    iget-object v4, p0, Lhnw;->g:Landroid/util/DisplayMetrics;

    invoke-static {v0, v4}, Lhnw;->a(Landroid/view/MotionEvent;Landroid/util/DisplayMetrics;)Ljava/util/ArrayList;
    ...
    iput-object v0, v5, Lbox;->a:Ljava/lang/Long;
    ...
    iput-object v0, v5, Lbox;->b:Ljava/lang/Long;

    iget-object v0, v2, Lbow;->z:[Lbox;

    aput-object v5, v0, v1
    :try_end_7
    .catch Lhnx; {:try_start_7 .. :try_end_7} :catch_0
    ...
    iput-object v0, v2, Lbow;->r:Ljava/lang/String;
    :try_end_9
    .catch Lhnx; {:try_start_9 .. :try_end_9} :catch_3
    ...
    iput-object v0, v2, Lbow;->s:Ljava/lang/Long;
    :try_end_a
    .catch Lhnx; {:try_start_a .. :try_end_a} :catch_2
