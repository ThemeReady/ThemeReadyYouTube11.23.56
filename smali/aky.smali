...
.method constructor <init>(Landroid/widget/ProgressBar;)V
    ...
    .line 48
    iput-object p1, p0, Laky;->c:Landroid/widget/ProgressBar;
...
.method private final a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 77
    invoke-direct {p0, v0, p2}, Laky;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    :goto_2
    invoke-direct {p0, v6, v0}, Laky;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 102
    iput-object v1, p0, Laky;->a:Landroid/graphics/Bitmap;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    .line 53
    iget-object v0, p0, Laky;->c:Landroid/widget/ProgressBar;

    invoke-virtual {v0}, Landroid/widget/ProgressBar;->getContext()Landroid/content/Context;

    move-result-object v0

    sget-object v1, Laky;->b:[I

    invoke-static {v0, p1, v1, p2}, Laql;->a(Landroid/content/Context;Landroid/util/AttributeSet;[II)Laql;

    move-result-object v4

    .line 56
    invoke-virtual {v4, v3}, Laql;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 58
    iget-object v5, p0, Laky;->c:Landroid/widget/ProgressBar;
    ...
    invoke-direct {p0, v7, v9}, Laky;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 61
    :cond_2
    invoke-virtual {v4, v9}, Laql;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 63
    iget-object v1, p0, Laky;->c:Landroid/widget/ProgressBar;

    invoke-direct {p0, v0, v3}, Laky;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
