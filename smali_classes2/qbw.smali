...
# instance fields
.field private g:Lqcn;


# direct methods
.method private constructor <init>(Llcj;Ljava/security/Key;Llcj;Lrma;Llog;)V
    .locals 3

    .prologue
    .line 66
    invoke-direct {p0, p2, p3, p4}, Lrmb;-><init>(Ljava/security/Key;Llcj;Lrma;)V

    .line 67
    new-instance v0, Lqcn;

    invoke-direct {v0, p2, p5, p1}, Lqcn;-><init>(Ljava/security/Key;Llog;Llcj;)V

    iput-object v0, p0, Lqbw;->g:Lqcn;

    .line 1152
    iget-object v0, p0, Lrmb;->c:Lorg/apache/http/protocol/HttpRequestHandlerRegistry;

    .line 68
    const-string v1, "/pudl"

    iget-object v2, p0, Lqbw;->g:Lqcn;
...
.method public static a(Llcj;Ljava/security/Key;Llcj;Lrma;Llog;)Lqbw;
    .locals 7
    ...
    invoke-direct/range {v0 .. v5}, Lqbw;-><init>(Llcj;Ljava/security/Key;Llcj;Lrma;Llog;)V
    ...
    iput-object v1, v0, Lrmb;->e:Ljava/net/ServerSocket;
    ...
    .line 1146
    iget-object v2, v0, Lrmb;->e:Ljava/net/ServerSocket;
    ...
    iput-object v1, v0, Lrmb;->f:Ljava/util/concurrent/ExecutorService;

    .line 1148
    iget-object v1, v0, Lrmb;->f:Ljava/util/concurrent/ExecutorService;

    new-instance v2, Lrmc;

    invoke-direct {v2, v0}, Lrmc;-><init>(Lrmb;)V
...
.method public final a(Ljava/lang/String;ILjava/lang/String;JJJ)Landroid/net/Uri;
    ...
    .line 1160
    iget-object v1, p0, Lrmb;->e:Ljava/net/ServerSocket;
    ...
    .line 2156
    iget-object v1, p0, Lrmb;->d:Lrmu;

    .line 90
    invoke-virtual {v1, v0}, Lrmu;->a(Landroid/net/Uri;)Landroid/net/Uri;
