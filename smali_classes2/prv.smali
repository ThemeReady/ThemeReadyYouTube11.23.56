...
.field private synthetic b:Llog;

.field private synthetic c:Lprt;


# direct methods
.method public constructor <init>(Lprt;ZLlog;)V
    .locals 0

    .prologue
    .line 115
    iput-object p1, p0, Lprv;->c:Lprt;

    iput-boolean p2, p0, Lprv;->a:Z

    iput-object p3, p0, Lprv;->b:Llog;
...
.method public final run()V
    ...
    .line 118
    iget-object v3, p0, Lprv;->c:Lprt;

    iget-boolean v4, p0, Lprv;->a:Z

    iget-object v5, p0, Lprv;->b:Llog;

    .line 1089
    iget-object v0, v3, Lprt;->b:Lpqx;

    iget-object v6, v3, Lprt;->a:Landroid/content/SharedPreferences;

    iget-object v7, v3, Lprt;->c:Landroid/content/Context;

    .line 2093
    invoke-interface {v0}, Lpqx;->a()Z
    ...
    .line 3065
    invoke-static {v7}, Lpsa;->a(Landroid/content/Context;)Ljava/lang/Boolean;
    ...
    .line 3114
    invoke-static {v6}, Lpsa;->b(Landroid/content/SharedPreferences;)Ljava/lang/Long;
    ...
    .line 1142
    invoke-static {v6}, Lpsa;->a(Landroid/content/SharedPreferences;)V

    .line 1089
    :cond_1
    if-nez v0, :cond_2

    iget-object v0, v3, Lprt;->a:Landroid/content/SharedPreferences;
